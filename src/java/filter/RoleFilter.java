 ...
 *   3 = Staff           – chấm công, ca làm việc
 *   4 = Cashier         – thu ngân (mẫu DB)
 *   5 = Saler           – khách hàng, khuyến mãi
 *
 * Mapping dựa trên admin-sidebar.jsp:
 *   /pos                           → 1 (Manager), 3 (Staff), 5 (Saler)
...
public class RoleFilter implements Filter {
    ...
    static {
        ...
        // ── POS – Manager + Staff + Saler (theo bảng Roles: 1, 3, 5)
