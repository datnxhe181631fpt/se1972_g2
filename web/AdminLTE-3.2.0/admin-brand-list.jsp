        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <c:if test="${param.msg == 'delete_success'}">
                    <div class="alert alert-success alert-dismissible fade show">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        <i class="icon fas fa-check"></i> Ẩn thương hiệu thành công!
                    </div>
                </c:if>
                ...
                <c:if test="${param.msg == 'activate_success'}">
                    <div class="alert alert-success alert-dismissible fade show">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        <i class="icon fas fa-check"></i> Kích hoạt thương hiệu thành công!
                    </div>
                </c:if>
                                            ...
                                            <c:choose>
                                                <c:when test="${brand.isActive}">
                                                    <button type="button" class="btn btn-danger btn-sm" 
                                                            onclick="confirmToggle(${brand.brandID}, '${brand.brandName}', false)" 
                                                            title="Ẩn">
                                                ...
                                                <c:otherwise>
                                                    <button type="button" class="btn btn-success btn-sm" 
                                                            onclick="confirmToggle(${brand.brandID}, '${brand.brandName}', true)" 
                                                            title="Kích hoạt">
...
function confirmToggle(id, name, activate) {
    if (activate) {
        ...
        $('#modalMessage').html('Bạn có chắc chắn muốn <strong>kích hoạt</strong> thương hiệu <strong>' + name + '</strong>?');
        ...
        $('#modalMessage').html('Bạn có chắc chắn muốn <strong>ẩn</strong> thương hiệu <strong>' + name + '</strong>?');
        $('#confirmToggleBtn').removeClass('btn-success').addClass('btn-danger').html('<i class="fas fa-eye-slash"></i> Ẩn');
    }
    
    $('#confirmToggleBtn').attr('href', '<%= request.getContextPath() %>/admin/brands?action=toggle&id=' + id);
