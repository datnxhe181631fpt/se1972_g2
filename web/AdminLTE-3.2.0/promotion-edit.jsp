                                                ...
                                                <div class="section-block">
                                                    ...
                                                    <div class="rule-row rule-section-dynamic" id="rule-PERCENT">
                                                        ...
                                                        <div class="input-group" style="width:160px;">
                                                            <input type="number" class="form-control promo-input"
                                                                ...
                                                                value="${(promotion.discount.discountType eq 'PERCENT') ? promotion.discount.discountValue : ''}"
                                                                placeholder="VD: 20">
                                                            <div class="input-group-append">
                                                    ...
                                                    <div class="rule-row rule-section-dynamic" id="rule-FIXED">
                                                        ...
                                                        <div class="input-group" style="width:180px;">
                                                            <input type="number" class="form-control promo-input"
                                                                name="fixedAmount" min="0"
                                                                value="${(promotion.discount.discountType eq 'FIXED') ? promotion.discount.discountValue : ''}"
