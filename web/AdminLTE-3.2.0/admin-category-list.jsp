<%-- 
    ...
    Created on : Feb 22, 2026, 9:06:26 PM
    Author     : xuand
--%>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <c:if test="${param.msg == 'delete_success'}">
                    <div class="alert alert-success alert-dismissible fade show">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        <i class="icon fas fa-check"></i> Ẩn danh mục thành công!
                    </div>
                </c:if>
                ...
                <c:if test="${param.msg == 'activate_success'}">
                    <div class="alert alert-success alert-dismissible fade show">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        <i class="icon fas fa-check"></i> Kích hoạt danh mục thành công!
                    </div>
                </c:if>
                                            ...
                                            <c:choose>
                                                <c:when test="${cat.isActive}">
                                                    <button type="button" class="btn btn-danger btn-sm" 
                                                            onclick="confirmToggle(${cat.categoryID}, '${cat.categoryName}', false)" 
                                                            title="Ẩn">
                                                ...
                                                <c:otherwise>
                                                    <button type="button" class="btn btn-success btn-sm" 
                                                            onclick="confirmToggle(${cat.categoryID}, '${cat.categoryName}', true)" 
                                                            title="Kích hoạt">
...
function confirmToggle(id, name, activate) {
    if (activate) {
        ...
        $('#modalMessage').html('Bạn có chắc chắn muốn <strong>kích hoạt</strong> danh mục <strong>' + name + '</strong>?');
        ...
        $('#modalMessage').html('Bạn có chắc chắn muốn <strong>ẩn</strong> danh mục <strong>' + name + '</strong>?');
        $('#confirmToggleBtn').removeClass('btn-success').addClass('btn-danger').html('<i class="fas fa-eye-slash"></i> Ẩn');
    }
    
    $('#confirmToggleBtn').attr('href', '<%= request.getContextPath() %>/admin/categories?action=toggle&id=' + id);
