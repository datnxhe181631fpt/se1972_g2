    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fas fa-copyright"></i> ${brand != null ? 'Chỉnh sửa Thương hiệu' : 'Thêm Thương hiệu Mới'}</h1>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <form method="post" action="<%= request.getContextPath() %>/admin/brands" id="brandForm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Ví dụ: NXB Kim Đồng, NXB Trẻ, Fahasa</small>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="brandDomain" 
                                                   placeholder="Nhập domain thương hiệu (vd: nxbkimdong.com.vn, nxbtre.com.vn)">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mt-3 text-center">
                                            <img id="logoPreview" 
                                                 class="logo-preview ${brand != null && brand.logo != null ? 'show' : ''}" 
                                                 src="${brand != null ? brand.logo : ''}" 
                                                 alt="Logo Preview"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="pl-3">
                                    <li>Nhập domain thương hiệu (vd: <code>nxbkimdong.com.vn</code>)</li>
                                ...
                                <h6 class="mt-3"><i class="fas fa-book text-success"></i> Domain phổ biến:</h6>
                                <ul class="pl-3 small">
                                    <li><code>nxbkimdong.com.vn</code> - NXB Kim Đồng</li>
                                    <li><code>nxbtre.com.vn</code> - NXB Trẻ</li>
                                    <li><code>fahasa.com</code> - Fahasa</li>
                                    <li><code>alphabooks.vn</code> - Alpha Books</li>
                                </ul>
                            </div>
                        </div>
