<%-- 
    Document   : admin-category-detail
    Created on : Feb 22, 2026, 9:07:04 PM
    Author     : xuand
--%>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fas fa-list"></i> ${category != null ? 'Chỉnh sửa Danh mục' : 'Thêm Danh mục Mới'}</h1>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <form method="post" action="<%= request.getContextPath() %>/admin/categories" id="categoryForm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Ví dụ: Văn học Việt Nam, Sách thiếu nhi, Văn phòng phẩm</small>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="icon" name="icon" 
                                               ...
                                               placeholder="fas fa-book, fas fa-child...">
                                        <small class="form-text text-muted">Class CSS của icon (Font Awesome hoặc custom)</small>
                                        <div class="mt-2">
                                            <span id="iconPreview" class="${category != null ? category.icon : ''}" 
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="mt-3"><i class="fas fa-icons text-info"></i> Icon phổ biến:</h6>
                                <ul class="pl-3">
                                    <li><i class="fas fa-book"></i> fas fa-book</li>
                                    <li><i class="fas fa-child"></i> fas fa-child</li>
                                    <li><i class="fas fa-graduation-cap"></i> fas fa-graduation-cap</li>
                                    <li><i class="fas fa-pen"></i> fas fa-pen</li>
                                    <li><i class="fas fa-briefcase"></i> fas fa-briefcase</li>
                                    <li><i class="fas fa-flask"></i> fas fa-flask</li>
                                </ul>
                            </div>
                        </div>
...
$('#categoryForm').on('submit', function(e) {
    ...
    if (categoryName.length > 255) {
        e.preventDefault();
        alert('Tên danh mục phải có ít hơn 255 ký tự!');
        $('#categoryName').focus();
        return false;
    }
